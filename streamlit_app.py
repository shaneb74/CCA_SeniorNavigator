...
def main():
    ...
    if st.session_state.step == 1:
        ...
        try:
            with expander(f"Income — {names['A']}"):
            ...
            if st.session_state.get("include_b", False):
                with expander(f"Income — {names['B']}"):
            ...
            with expander("Income — Household"):
            ...
            with expander("Home costs (if keeping home)"):
                if inp.get("maintain_home", False):
                    try:
            ...
            with expander("Other monthly costs (optional)"):
                try:
            ...
            with expander("Assets — Common balances"):
            ...
            with expander("More asset types (optional)"):
